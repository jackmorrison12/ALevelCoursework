...
extension UserDefaults {
    var lastStreakDate: NSDate? {
        get {
            return object(forKey: "lastStreakDate") as? NSDate
        }
        set {
            guard let newValue = newValue else { return }
            guard let lastStreakDate = lastStreakDate
                else {
                    set(newValue, forKey: "lastStreakDate")
                    return
            }
            if !NSCalendar.current.isDateInToday(lastStreakDate as Date) {
...
class HomeViewController: UIViewController, UIPickerViewDelegate, UIPickerViewDataSource,UITextFieldDelegate  {
    ...
    var topicData: [String] = [String]() //In this line, we’re declaring a new Array instance variable to store the list of data. By declaring it here as an instance variable, we can access this variable from any method in this class and the variable will hold its value for the duration of the objects lifetime.
    ...
    func addDoneButtonOnKeyboard() {
        ...
        let done: UIBarButtonItem  = UIBarButtonItem(title: "Close Keyboard", style: UIBarButtonItemStyle.done, target: self, action: #selector(HomeViewController.doneButtonAction))
        let minus: UIBarButtonItem = UIBarButtonItem(title: "-", style: UIBarButtonItemStyle.done, target: self, action: #selector(HomeViewController.printMinus))
